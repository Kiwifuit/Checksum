...
@Command(name = "checksum", description = "Computes a file's SHA-256 checksum", subcommands = {
    com.misery.checksum.subcommands.Update.class,
    com.misery.checksum.subcommands.Check.class }, usageHelpAutoWidth = true, abbreviateSynopsis = true, versionProvider = com.misery.checksum.internal.VersionProvider.class)
